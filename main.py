...
def SocialDistancing():
    ...
    population1 = initializeSD(popSize=popsize1, infectedPercentage=iPerc, sickPercentage=sPerc, xlowerlimit=500,
                               xLimit=1000, ylowerlimit=0, yLimit=yLim,
                               SDPercentage=100)
    population2 = initializeSD(popSize=popsize2, infectedPercentage=iPerc, sickPercentage=sPerc, xlowerlimit=0,
...
def basicSim():
    # sim
    population1 = initialize(popSize=popsize1, infectedPercentage=iPerc, sickPercentage=sPerc, xlowerlimit=500,
                             xLimit=1000, ylowerlimit=0, yLimit=yLim)
    population2 = initialize(popSize=popsize2, infectedPercentage=iPerc, sickPercentage=sPerc, xlowerlimit=0,
                             xLimit=500, ylowerlimit=0, yLimit=yLim)
    population = population1.append(population2, ignore_index=True)
    simulation(population, lockdownFlag)
